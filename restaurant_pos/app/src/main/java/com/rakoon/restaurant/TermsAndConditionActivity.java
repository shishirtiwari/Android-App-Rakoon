...
public class TermsAndConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (apath.getLanguage(TermsAndConditionActivity.this).equalsIgnoreCase(getString(R.string.english))) {
            getSupportActionBar().setTitle(getResources().getString(R.string.term_en));
        } else if (apath.getLanguage(TermsAndConditionActivity.this).equalsIgnoreCase(getString(R.string.arabic))) {
            getSupportActionBar().setTitle(getResources().getString(R.string.term_ar));
        }
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        if (apath.isInternetOn(TermsAndConditionActivity.this))
            getTerms();
        else {
    ...
    void getTerms() {
        try {
            AlertDialog.Builder builder = new AlertDialog.Builder(TermsAndConditionActivity.this);
            ...
            RequestQueue queue = Volley.newRequestQueue(TermsAndConditionActivity.this);
            StringRequest sr = new StringRequest(Request.Method.POST, apath.getMethodUrl(apath.TERMS), new Response.Listener<String>() {
                @Override
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("lang", apath.getLang(TermsAndConditionActivity.this));
            ...
            Singleton.getIntance(TermsAndConditionActivity.this).addToRequestQueue(sr);
